...
//      }
  ...
  var utils = {
     ...
     * @returns {String}
     */
    updateFormula: function (formula, type, direction) {
      //(\$?[A-Za-z]+\$?[0-9]+)
    },
    ...
    /**
     * increment row cell number A1 -> A2
     * @param {String} cell
     * @returns {String}
     */
    incrementRowCell: function (cell) {
      var cellCoords = instance.utils.getCellAlphaNum(cell);

      return cellCoords.alpha + '' + cellCoords.num++;
    },

    /**
     * increment col cell number A1 -> B1 Z1 -> AA1
     * @param {String} cell
     * @returns {String}
     */
    incrementColCell: function (cell) {
  ...
  var helper = {
    ...
    cellValue: function (cell) {
      var value,
          ...
          //fnGetCellMeta = instance.custom.getCellMeta,
          //fnSetCellMetaObject = instance.custom.setCellMetaObject,
          element = this,
      ...
      if (instance.utils.isFunction(fnCellValue)) {
        ...
        //var cellMeta = instance.utils.isFunction(fnGetCellMeta) ? fnGetCellMeta(cellCoords.row, cellCoords.col) : null;

        //console.debug('cellMeta:', cellMeta);
