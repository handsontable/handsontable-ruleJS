  ...
  var utils = {
    ...
    changeRowIndex: function (cell, counter) {
      var cellCoords = instance.utils.getCellAlphaNum(cell),
          col = cellCoords.alpha,
          row = parseInt(cellCoords.num + counter, 10);
    ...
    changeColIndex: function (cell, counter) {
      var cellCoords = instance.utils.getCellAlphaNum(cell),
          col = instance.utils.toChar(parseInt(instance.utils.toNum(cellCoords.alpha) + counter, 10)),
          row = cellCoords.num;
  ...
  var helper = {
    ...
    cellValue: function (cell) {
      ...
      if (instance.utils.isFunction(fnCellValue)) {
        ...
        // get value
        value = item ? item.value : fnCellValue(cellCoords.row, cellCoords.col) || 0;
